...
{
logoIcon=new ImageIcon(this.getClass().getResource("/icons/logoIcon.jpg"));
...
JOptionPane.showMessageDialog(DesignationUI.this,"Data exported to file : "+file.getAbsolutePath());
